Engenharia de Software
    ...
    On Observer software engineering project, engineers need to be more concerned with the passage of time and the eventual need for change. 
    In Observer software engineering organization, we need to be more concerned about scale and efficiency, both for the software we produce as well as for the organization that is producing it. 
...
Interpretação
    ...
    ser mais preocupado com o tempo que é gasto, Observer eficiencia e tem muitos decisões que geram um grande risco, 
...
Engenharia de Software não é só programar
    ...
    Programming is certainly Observer significant part of software engineering: after all, programming is how you generate new software in the first place. 
...
Trade-Off
        ...
        1º trade-off - Meu sistema tem muito segurança para o usúario mas isso acaba diminuindo Observer usabilidade
...
Atividade 3 - (Escolha outro exemplo e faça na mesma atividade)
        ...
        Um outro exemplo para isso, é Observer Steam e Observer Epic Games
        onde Observer Steam tem um maior acesso de usúarios diariamente
        do que Observer Epic, um dos grandes motivos é o fato da acessibilidade
...
Acerto: Quando você consegue ver Observer trajetória do uber até chegar em você.
...
Acerto: Ao criar um aplicativo que simula uma bússola, fazer ela parecida como Observer vida real, assim fazendo assim que o usuário tenha uma familiaridade com o sistema.
...
Acerto: Botões de voltar que se forem usados podem quebrar Observer lógica subjacente e assim, ao o usuário clicar na opção gerar uma tela perguntando se deseja realmente voltar e explicando o que pode acontecer
...
Acerto: Sites que mantem Observer estrutura do site, como o link clicavel seja azul, um icone de engrenagem seja Observer de configurações, etc.
...
Acerto: Sites que completem Observer sua pesquisa conforme você for digitando, assim facilidando Observer pesquisa do usuário e ainda prevenindo dele escrever o nome do produto incorretamente.
...
Erro: Um formulário online que não fornece dicas contextuais ao usuário sobre o formato correto de entrada, obrigando-os Observer lembrar-se de regras específicas, como tem que botar o DDD ou () no número e etc.
...
Acerto: Criar atalhos para facilitar o usuário Observer navegar mais rapidamente no site.
        
Erro: Dificil acesso Observer uma certa informação e assim obrigando o usuário ter que fazer uma grande quantidade de etapas.
...
9 - Ajude os usuários Observer reconhecer, diagnosticar e se recuperar de erros
    
Acerto: Ter indicações que sejam amigaveis para usuário que não sejam experientes com o aplicativo.
        
Erro: Ao ocorrer um erro mostrar por exemplo o erro "404" e que mesmo que isso possa ser obvio para Observer maioria sempre vai ter alguem que não saberá o que significa.
